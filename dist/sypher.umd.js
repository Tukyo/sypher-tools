    ...
    const CryptoModule = {
        ...
        getPriceFeed: async function (pair = "ethereum") {
            ...
            try {
                ...
                const contract = new ethers.ethers.Contract(proxy, CHAINLINK_ABI, web3);
                ...
                if (pairData["usd"]) {
                    ...
                    const ethUSDContract = new ethers.ethers.Contract(ethUSD, CHAINLINK_ABI, web3);
        ...
        clean: function (details) {
            ...
            const cleanedDetails = {
                user: {
                    ...
                    ens,
                    ethBalance,
                    tokenBalance: parseFloat(ethers.ethers.utils.formatUnits(balance, decimals)),
